...
public class Funcionario{
  ...
  //construtores
  public Funcionario(int rg, String nome, double salario, int dia_nasc, int mes_nasc, int ano_nasc, int dia_admi, int mes_admi, int ano_admi)
  {
    this.rg=rg;
    this.nome=nome;
  ...
  {
    this(rg, nome, salario, 1, 1, 1, 1, 1, 1);
  }

  public Funcionario()
  {
    this(0,"", 0.0,1,1,1,1,1,1);
  }
